...
// //validated signup form with react-hook-form
// const Signup = () => {
...
//     formState: { errors },
//   } = useForm();
//   const submitHandler = async ({ name, email, password, accType }) => {
//     try {
...
//                   type="text"
//                   className="placeholder:text-gray-400 bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 mt-2"
//                   placeholder="Pittford wales"
//                   {...register("name", {
...
//                   Are You An Admin?
//                 </label>
//                 <label className="relative inline-block w-42 h-8">
//                   <input
//                     id="accType"
//                     aria-labelledby="accType"
//                     type="checkbox"
//                     className=" peer w-0 h-0 backdrop-opacity-0"
//                     {...register("accType", {})}
//                   />
//                   <span
//                     className="absolute h-8 w-14 left-0 bottom-0 right-0 top-0 bg-gray-400 transition duration-400 rounded-full before:absolute before:h-6 before:w-6 before:left-1 before:bottom-1 
//                                 before:bg-white before:transition before:duration-400 before:rounded-full peer-checked:bg-blue-600 peer-checked:before:shadow peer-checked:before:translate-x-6"
//                   ></span>
//                 </label>

//                 {errors.accType && (
//                   <div className="text-red-500">{errors.accType.message}</div>
//                 )}
//               </div>
//               <div className="mt-8">
//                 <button
...
//                 <Link href={`/?redirect=${redirect || "/"}`}>Click here</Link>
//               </p>
//             </div>
//           </div>
//         </div>
